---
title: 如何制作一个标准的 RPM 包
layout: post
comments: true
language: chinese
tag: [Linux,DevOps,SoftWare]
keywords: linux,rpm,制作
description: RPM 是一个通用的包管理规范，同时包含了一系列的打包、管理工具，包括了 OpenLinux、RedHat、CentOS、SuSE、TurboLinux 等多个 Linux 发行版本都在使用。这里详细介绍 RPM 的打包方式，以及一些常用的技巧。
---
