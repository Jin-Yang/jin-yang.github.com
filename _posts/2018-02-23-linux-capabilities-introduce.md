---
title: Linux Capabilites 机制详细介绍
layout: post
comments: true
language: chinese
tag: [Linux,Program,DevOps]
keywords: linux,root,capabilites
description: Linux 提供了 capabilites 机制，将 root 权限又进行了细分，这样允许进程在使用普通用户执行时，仍然具有部分 root 的权限，这里详细介绍如何使用这一机制。
---
