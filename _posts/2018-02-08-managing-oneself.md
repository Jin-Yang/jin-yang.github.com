...
language: chinese
category: [misc]
keywords: 彼得·德鲁克, Peter F．Drucker
description:
---
...
![logo]({{ site.url }}/images/lifes/drucker-logo.jpg "logo"){: .pull-center width="80%"}
...
![logo]({{ site.url }}/images/lifes/drucker-01.jpg "logo"){: .pull-center width="50%"}
...
![logo]({{ site.url }}/images/lifes/drucker-02.jpg "logo"){: .pull-center width="50%"}
...
![logo]({{ site.url }}/images/lifes/drucker-03.jpg "logo"){: .pull-center width="50%"}
...
![logo]({{ site.url }}/images/lifes/drucker-04.jpg "logo"){: .pull-center width="80%"}
...
然而，他们的同学有这种记忆的却很少。他们可能在学校里得不到什么乐趣，对他们来说上学的最大痛苦是无聊。
...
![logo]({{ site.url }}/images/lifes/drucker-05.jpg "logo"){: .pull-center width="50%"}
...
![logo]({{ site.url }}/images/lifes/drucker-06.jpg "logo"){: .pull-center width="45%"}
...
![logo]({{ site.url }}/images/lifes/drucker-07.jpg "logo"){: .pull-center width="60%"}
...
![logo]({{ site.url }}/images/lifes/drucker-08.jpg "logo"){: .pull-center width="60%"}
...
![logo]({{ site.url }}/images/lifes/drucker-09.jpg "logo"){: .pull-center width="50%"}
...
![logo]({{ site.url }}/images/lifes/drucker-10.jpg "logo"){: .pull-center width="55%"}
...
![logo]({{ site.url }}/images/lifes/drucker-11.jpg "logo"){: .pull-center width="55%"}
...
![logo]({{ site.url }}/images/lifes/drucker-12.jpg "logo"){: .pull-center width="60%"}
...
许多人的第一职业十分成功，他们还会继续从事原有工作，或全职或兼职，甚至只是当顾问。但是，除此之外，他们会开创一项平行的工作，通常是在非营利机构，每周占用10个小时。
