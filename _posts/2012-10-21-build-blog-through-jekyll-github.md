...
description: 利用 Github Pages 搭建一个简单的 Blog ，使用的是 Jekyll 引擎，这里会介绍详细的搭建步骤，开发阶段如何使用，添加对 MathJax 的支持等等。
---
...
![jekyll logo](/{{ site.imgdir }}/linux/jekyll-logo.png "jekyll logo")

## 简介

Jekyll 是一个简单的静态网站生成器，使用 Ruby 编写，通过 Markdown 和 Liquid 模板生成内容，类似的还有 Hexo(JavaScript)、Hugo(Go) 等。
...
同时包括了Liquid语法的简单介绍
https://gist.github.com/biezhi/f88be58ef4ae0f3741bb36ab8daa53c5

Jekyll 可以综合 mermaid 使用流程图
https://mermaid-js.github.io/mermaid/#/
http://www.igithub.top/2018/07/10/using-mermaid-in-Jekyll/
-->
